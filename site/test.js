...
var Component, Slide, Test, _, card, h, rand, randomColor, rbg, rc, render, seed, toggle;

({h, render, Component} = __webpack_require__(0));

Slide = __webpack_require__(1);

randomColor = __webpack_require__(29);

seed = __webpack_require__(39);
...
rc = function() {
  return rand().toString(36).substring(7, 9);
};
...
var string = __webpack_require__(38);
